...
export class ChartsDataService {
  ...
  getNg2ChartsData(): Promise<any> {
    if (this.ng2Data) {
      ...
      return new Promise((resolve, reject) => {
        this.http.get('../../../../assets/data/ng2_charts.json').subscribe(
          data => {
            this.ng2Data = data.json();
  ...
  getNg2Nvd3ChartsData(): Promise<any> {
    if (this.ng2Nvd3Data) {
      ...
      return new Promise((resolve, reject) => {
        this.http.get('../../../../assets/data/ng2_nvd3_charts.json').subscribe(
          data => {
            this.ng2Nvd3Data = data.json();
            resolve ({ data: this.ng2Nvd3Data, options: this.ng2Nvd3Options });
          },
          err => reject()
        );
